...
export const FAQ: FaqEntry[] = [
  ...
  },
  {
    id: 'penalty_fine',
    match:
      /(штраф|айыппұл|fine|penalt)\w*.{0,26}(не сда|просроч|деклар|910|кешік|late|declaration|filing)|что будет если не сдать|не сдал деклар|декларацияны тапсырмаса/i,
    reply: {
